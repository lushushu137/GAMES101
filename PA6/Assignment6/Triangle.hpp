...
public:
    MeshTriangle(const std::string& filename)
    {
        ...
        for (auto& tri : triangles)
            ptrs.push_back(&tri);
    std::cout<<"ptrs.size() in MeshTriangle:"<<ptrs.size()<<std::endl;
    ...
    // std::cout<<"insideIntersection getIntersection(Ray ray)"<<std::endl;
...
{
    Intersection inter;
    // std::cout<<"inside inline Intersection Triangle::getIntersection(Ray ray)"<<std::endl;
